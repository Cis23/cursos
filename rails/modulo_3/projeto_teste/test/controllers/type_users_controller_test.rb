...
class TypeUsersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type_user" do
    assert_difference('TypeUser.count') do
      post type_users_url, params: { type_user: { action: @type_user.action, description_name: @type_user.description_name } }
    end
  ...
  test "should update type_user" do
    patch type_user_url(@type_user), params: { type_user: { action: @type_user.action, description_name: @type_user.description_name } }
